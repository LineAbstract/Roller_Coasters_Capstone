...
while True:
    ...
    for coaster_group in coasters_tbody:
        coaster_group = driver.find_elements(By.XPATH, '/html/body/section/div[2]/table/tbody/tr[1]')

        for coaster in coaster_group:
            coaster_name = driver.find_element(By.TAG_NAME, 'td[1]')
